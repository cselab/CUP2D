...
void bindShapes(py::module &m) {
  class_shared<Shape>(m, "_Shape")
      .def_property_readonly(
          "data", [](Shape *shape) { return &shape->sim; },
      ...
      .def_property_readonly("force_P",
                             xyToPair(&Shape::forcex_P, &Shape::forcey_P))
      .def_property_readonly("force_V",
                             xyToPair(&Shape::forcex_V, &Shape::forcey_V))
