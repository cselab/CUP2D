"${main=./main}" \
    ...
    -bMeanConstraint 2 \
    -shapes 'disk radius=0.1 xpos=5.0 ypos=3.375 bForced=1 bFixed=1 xvel=0.2 breakSymmetryExponent=1.0 breakSymmetryStrength=0.5 breakSymmetryType=1 breakSymmetryTime=3.0
