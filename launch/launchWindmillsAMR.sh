...
OPTIONS="-bpdx $BPDX -bpdy $BPDY -levelMax $LEVELS -Rtol $RTOL -Ctol $CTOL -extent $EXTENT -CFL $CFL -tdump 0.1 -nu $NU -poissonTol 1.0e-3 -tend 200 -muteAll 0 -verbose 1 -poissonTolRel 0 -poissonSolver cuda_iterative"
