...
OPTIONS="-bpdx ${BPDX} -bpdy ${BPDY} -tdump 0.01 -nu 0.0001236363636 -tend 1.5882352941 -CFL ${CFL} "
OBJECTS='cstartfish L=0.20 T=0.5882352941 xpos=0.50 ypos=0.50 angle=-98
'
