...
OPTIONS="-bpdx $BPDX -bpdy $BPDY -levelMax $LEVELS -levelStart 4 -Rtol $RTOL -Ctol $CTOL -extent $EXTENT -CFL $CFL -tdump 0.1 -nu $NU -tend 100 -muteAll 0 -verbose 0 -poissonTol $PT -poissonTolRel $PTR -maxPoissonRestarts 5 -maxPoissonIterations 1000 -bAdaptChiGradient 0 -bMeanConstraint 1"
