...
OPTIONS="-bpdx ${BPDX} -bpdy ${BPDY} -tdump 0.01 -nu 0.0001931818182 -tend 1.5 -CFL ${CFL} "
OBJECTS='neurokinematicfish L=0.25 T=0.5882352941 xpos=0.50 ypos=0.50 angle=-98
'
