...
Teardrop::Teardrop(SimulationData&s, ArgumentParser&p, double C[2])
...
void Teardrop::updateVelocity(double dt)
{
...
void Teardrop::updateLabVelocity( int nSum[2], double uSum[2] )
{
  if(bFixedx){
   (nSum[0])++; 
   if( sim.time < tAccel )
