...
void Simulation::parseRuntime()
{
  ...
  sim.PoissonTol = parser("-poissonTol").asDouble(1e-6); //poisson eq. error tolerance
  sim.PoissonTolRel = parser("-poissonTolRel").asDouble(1e-4); //poisson eq. relative error tolerance
