...
public:
    ...
    inline void resetIC(CStartFish* const a, smarties::Communicator*const c)
    {
        ...
        a->setVirtualOrigin(vo);
        std::uniform_real_distribution<Real> disEnergy(0.003053, 0.02748);  // 0.00243, 0.0219 or 0.002827, 0.02544
        baselineEnergy = c->isTraining() ? disEnergy(c->getPRNG()) : 0.00916;
